...
local Window = Library:CreateWindow('MadeBybengi') -- CREATE WINDOW
...
local Tab = { -- CREATE TABS
    ...
    Tab_8 = Window:addTab('#Credits')
    
}

local Home_Left = Tab.Tab_1:addSection() -- HOME LEFT SECTION
local Changelog = Home_Left:addMenu("#YENI GELENLER")
...
Changelog:addChangelog('- MADE BY BENGI_Uw')
...
task.spawn(function()
    while wait() do
        if getgenv().AntiKickClient then
            loadstring(game:HttpGet('https:https://you.whimper.xyz/sources/btteam/SystemUI.lua/gitlab.com/Sky2836/BT/-/raw/main/antikickclient'))()
        end
    end
end)
